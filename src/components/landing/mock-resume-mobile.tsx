  ...
  return (
    <Card className="w-full max-w-[6in] aspect-[8.5/11] bg-white relative p-4 font-sans 
      ...
      <div className="mb-4 text-center">
        <h2 className="text-base font-bold text-gray-900 mb-0.5">Kushagra Juneja</h2>
      ...
      <div className="mb-3">
        ...
        <div className="space-y-2">
          <div>
            ...
            <p className="text-[8px] font-medium text-gray-700 mb-0.5">New Delhi, India</p>
        ...
        <div className="space-y-1.5">
          <div>
            <div className="flex justify-between items-baseline">
              ...
              <p className="text-[8px] text-gray-600">github.com/ku28/prepai</p>
            </div>
            <ul className="text-[8px] text-gray-600 list-disc list-outside ml-2.5 space-y-0.5">
      ...
      <div>
        ...
        <div>
          <div className="flex justify-between items-baseline mb-0.5">
            <h4 className="text-[9px] font-semibold text-gray-800">BE. Computer Science</h4>
            <p className="text-[8px] text-gray-600">2026</p>
          </div>
          <p className="text-[8px] text-gray-600">Chitkara University, Rajpura, Punjab</p>
